...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-01stq=)^(p$yxsn+^)@-6r@uibabd0nw5)@^#ulmqs*41cfp$9')
...
# For production, specify the exact origins that are allowed to connect.
